...
The sample includes data on homelessness and unemployment rates, cost-of-living indexes, along with the factors used to calculate it, and more, across all 50 states and the District of Columbia. This data was collected in September 2023 and can be found below and is a cross-sectional analysis.
...
After analyizing both the linear regression table and graph, we are shown a positive correlating relathionship between Cost of Living Index and homelessness rates per 10,000 people in states. Additonally, since this is shown to be statistically significant through are p value and our additonal analysis of a possible confounder, there is strong support for my hypothesis. However, despite this, there are limitations to my analysis such as this only taking into account only one confounder variable, as there could a multitude such as population, and that it is only a cross sectional design (a snapshot of a point in time). Furthermore, one cannot feasibly or ethically do a randomized controlled study of cost of living index and homelessness, which, in the current scope of this analyis, makes it impossible to establish a causal relationship between the two variables. If I had more time, I would do a difference-in-differences analysis of this relationship over multiple years, not just 2022. However, I believe this is an interesting and informative snapshot look at how cost of living index and rates of homeless in states correlate with each other.
